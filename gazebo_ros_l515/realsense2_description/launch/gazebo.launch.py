...
def generate_launch_description():
    ...
    camera_info_bridge = Node(
        ...
        arguments=[
        # Color
        '/world/empty/model/l515_camera/link/base_link/sensor/cameracolor/image@sensor_msgs/msg/Image[gz.msgs.Image',
        '/world/empty/model/l515_camera/link/base_link/sensor/cameracolor/camera_info@sensor_msgs/msg/CameraInfo[gz.msgs.CameraInfo',

        # Depth
        '/world/empty/model/l515_camera/link/base_link/sensor/cameradepth/depth_image@sensor_msgs/msg/Image[gz.msgs.Image',
        '/world/empty/model/l515_camera/link/base_link/sensor/cameradepth/camera_info@sensor_msgs/msg/CameraInfo[gz.msgs.CameraInfo',
        '/world/empty/model/l515_camera/link/base_link/sensor/cameradepth/depth_image/points@sensor_msgs/msg/PointCloud2[gz.msgs.PointCloudPacked',
